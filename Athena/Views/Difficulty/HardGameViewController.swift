...
class HardGameViewController: UIViewController {
    ...
    private var usedIndexes: Set<Int> {
        get {
            if let storedIndexes = UserDefaults.standard.object(forKey: "hardUsedIndexes") as? [Int] {
        ...
        set {
            UserDefaults.standard.set(Array(newValue), forKey: "hardUsedIndexes")
        }
    }

    private var correctTimes: [String] {
        get {
            if let storedTimes = UserDefaults.standard.object(forKey: "hardCorrectTimes") as? [String] {
                return storedTimes
            } else {
                return []
            }
        ...
        set {
            UserDefaults.standard.set(newValue, forKey: "hardCorrectTimes")
        }
    }
    ...
    private func loadDataFrameFromCSV() {
        dataFrame = DataFrame(fromCSVFile: "trivia_mc - Hard")
